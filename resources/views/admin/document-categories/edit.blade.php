...
<div class="mb-6">
    ...
    <h1 class="font-display text-xl sm:text-2xl font-bold text-slate-800 leading-snug">Ubah Kategori</h1>
    <p class="text-sm text-slate-500 mt-1">Mengubah “{{ $category->name }}”.</p>
</div>
